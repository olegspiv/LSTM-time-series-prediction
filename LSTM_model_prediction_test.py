...
class SinusInfiniteModel:
    def __init__(self,
                 ...
                 epochs=100,
                 batch_size=32):
        self.minimum = minimum  # Minimum parameter determines the sequence steps used for training and prediction.
        self.n_features = n_features  # Specifies the number of features for each input timestep.
        self.reps = reps  # Defines the number of prediction cycles to perform.
        self.kama = kama  # Kama sets the threshold for processing sequence points during iterative prediction.
        self.timeline_end = timeline_end  # Specifies the end point of the sinusoidal timeline.
        self.timeline_step = timeline_step  # Defines the increment between consecutive timeline points.
        self.train_split = train_split  # Specifies the split point between training and testing datasets.
        self.lstm_units = lstm_units  # Defines the number of units in the LSTM layer, controlling its capacity.
        self.lstm_activation = lstm_activation  # Specifies the activation function for the LSTM layer.
        self.dense_activation = dense_activation  # Specifies the activation function for the Dense layer.
        self.loss_function = loss_function  # Defines the loss metric for training the model.
        self.optimizer = optimizer  # Specifies the optimization algorithm used for training.
        self.epochs = epochs  # Defines the number of iterations over the training dataset.
        self.batch_size = batch_size  # Specifies the number of samples processed in each training batch.
